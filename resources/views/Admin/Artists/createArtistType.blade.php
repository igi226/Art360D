...
@section('title', 'Artist-type|Art360')
    ...
    <div class="page-content">
       <div class="container-fluid">
          ...
          <div class="row">
             <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                   <h4 class="mb-0">Create artist type</h4>
          ...
          <div class="card custom-shadow rounded-lg border">
              <div class="card-body">
                <form action="{{ route("artisttypes.store") }}" method="POST">
                    @csrf
                   <div class="row">
                      <div class="col-lg-2">
                         ...
                         <div class="mt-3">
                            <div class="form-group mb-3">
                               <div class="row align-items-center">
                                  ...
                                  <div class="col-lg-6">
                                     <input type="text" class="form-control font-size-13 custom-shadow" name="artist_type">
