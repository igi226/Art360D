                        ...
                        <div class="card custom-shadow rounded-lg border">
                            <div class="card-body">
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>{{ $artist->first_name }} {{ $artist->last_name }}
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                              ...
                              @endphp --}}
                                                    ...
                                                    <td><span
                                                            class="badge rounded-pill badge-soft-primary font-size-12">{{ @$artist->user_artist->feature_artist }}</span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('artists.show', $artist->id) }}"
                                                            class="btn btn-success btn-xs"><i class="far fa-eye"></i></a>
