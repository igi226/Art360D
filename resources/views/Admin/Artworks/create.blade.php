...
@section('title', 'Create-Artwork|Art360')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" value="{{ old('edition') }}"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <input type="text" value="{{ old('width') }}"
                                                            placeholder="Width"
                                                            class="form-control font-size-13 custom-shadow"
                                                            name="width">
                                                        @if ($errors->has('width'))
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                {{-- <button class="btn btn-primary custom-shadow">Put on market</button> --}}
    ...
    <script>
        ...
        function bidFunction() {
            ...
            if (checkBox.checked == true) {
                bidForm =
                    '<div class="form-group mb-3"><div class="row align-items-center"><label class="col-lg-3 fw-bold font-size-13"> Auction Starting price:</label><div class="col-lg-9"><input type="text" class="form-control font-size-13 custom-shadow"name="auction_starting_price"></div></div></div><div class="form-group mb-3"><div class="row align-items-center"><label class="col-lg-3 fw-bold font-size-13"> Auction End price:</label><div class="col-lg-9"><input type="text" class="form-control font-size-13 custom-shadow"name="auction_end_price"></div></div></div><div class="form-group mb-3"><div class="row align-items-center"><label class="col-lg-3 fw-bold font-size-13">Auction Reserve price:</label><div class="col-lg-9"><input type="text" class="form-control font-size-13 custom-shadow"name="auction_reserve_price"></div></div></div><div class="form-group mb-3"> <div class="row align-items-center"><label class="col-lg-3 fw-bold font-size-13">Auction Starting Date:</label><div class="col-lg-9"><input type="date" class="form-control font-size-13 custom-shadow"name="auction_start_date"></div></div></div><div class="form-group mb-3"><div class="row align-items-center"><label class="col-lg-3 fw-bold font-size-13">Auction Ending Date:</label><div class="col-lg-9"><input type="date" class="form-control font-size-13 custom-shadow"name="auction_end_date"></div></div></div>';
