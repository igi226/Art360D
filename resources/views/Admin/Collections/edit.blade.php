...
@section('title', 'Edit-collection|Art360')
                         ...
                         <div class="mt-3">
                            <div class="form-group mb-3">
                               <div class="row align-items-center">
                                  ...
                                  <div class="col-lg-6">
                                     <input type="text" class="form-control font-size-13 custom-shadow" name="name" value="{{ $collection->name }}">
                                     @if ($errors->has('name'))
                            ...
                            {{-- <div class="form-group mb-3">
                             ...
                             <div class="form-group mb-3">
                                <div class="row align-items-center">
                                   ...
                                   <div class="col-lg-6">
                                    <img id="preview-image-before-upload" src="{{ asset('storage/CollectionImage/'. $collection->image ) }}" alt="preview image" style="max-height: 250px;">
                                   </div>
                                </div>
                             </div> --}}
                             ...
                             <div class="form-group mb-3">
                                <div class="row align-items-center">
                                   <label class="col-lg-3 fw-bold font-size-13">Status:</label>
                                   <div class="col-lg-6">
                                      <select name="status" class="form-control font-size-13 custom-shadow">
                                        <option {{ $collection->status == 1 ? "selected" : ""}} value="1">Publish</option>
                                        <option {{ $collection->status == 0 ? "selected" : ""}} value="0">Unpublish</option>
                                      </select>
